...
def getScriptPath(dcc):
    """
    Gets the path to the installation script of the given dcc by joining piper directory, and other piper directories.
    ...
    install_script_path = os.path.normpath(os.path.join(piper_directory, pcfg.install_script_path, install_script))
